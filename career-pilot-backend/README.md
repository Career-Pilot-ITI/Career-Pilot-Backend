...
| `LLM_API_KEY` | ✅ | — | API key for OpenAI-compatible providers (required for OpenAI or Gemini) |
| `LLM_MODEL` | ❌ | `gemini-3.1-flash-lite` | Model name |
| `LLM_TEMPERATURE` | ❌ | `0.4` | Response creativity (temperature) |
| `OPENAI_BASE_URL` | ❌ | `https://generativelanguage.googleapis.com/v1beta/openai` | OpenAI-compatible API endpoint (defaults to Gemini) |
